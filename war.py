            ...
            if player_one_cards[-1].value > player_two_cards[-1].value:
               #Player one wins round
                ...
                if len(player_one.all_cards) < 3: 
                    print(f'{player_one.name} does not have enough cards to go to war! {player_two.name} Wins!!')
                    AT_WAR = False
                    break              
                elif len(player_two.all_cards) < 3:
                    print(f'{player_two.name} does not have enough cards to go to war! {player_one.name} Wins!!')
                    AT_WAR = False
                    break
